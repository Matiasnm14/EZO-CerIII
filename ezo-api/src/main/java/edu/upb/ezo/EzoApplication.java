...
//		}
//
//		List<EzoMetodoPagoResponse> metodoPagoResponses = ezo.getList(token,"pruebas/metodos-pago", new ParameterizedTypeReference<List<EzoMetodoPagoResponse>>() {});
